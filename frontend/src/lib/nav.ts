...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'OEE Dashboard', path: '/oee', roles: ['ADMIN', 'PRODUCTION_MANAGER'], group: 'OEE', icon: Gauge },
  { label: 'Line-wise Overview', path: '/line-wise', roles: ['ADMIN', 'PRODUCTION_MANAGER', 'LINE_SUPERVISOR'], group: 'OEE', icon: Monitor },
  { label: 'Day-wise OEE', path: '/day-wise-oee', roles: ['ADMIN', 'PRODUCTION_MANAGER', 'LINE_SUPERVISOR'], group: 'OEE', icon: CalendarDays },
  { label: 'Week-wise OEE', path: '/week-wise-oee', roles: ['ADMIN', 'PRODUCTION_MANAGER', 'LINE_SUPERVISOR'], group: 'OEE', icon: CalendarRange },
  { label: 'OEE Guidance', path: '/oee-guidance', roles: ['ADMIN', 'PRODUCTION_MANAGER', 'LINE_SUPERVISOR'], group: 'OEE', icon: BookOpen },
  { label: 'Plan vs Actual', path: '/plan-vs-actual', roles: ['ADMIN', 'PRODUCTION_MANAGER'], group: 'OEE', icon: ChartColumnIncreasing },
  { label: 'Top 5 Analysis', path: '/top5-analysis', roles: ['ADMIN', 'PRODUCTION_MANAGER', 'LINE_SUPERVISOR'], group: 'OEE', icon: Trophy },

  { label: 'Sales Dashboard', path: '/sales-dashboard', roles: ['ADMIN', 'PRODUCTION_MANAGER'], group: 'Sales', icon: ShoppingCart },
  { label: 'Sales Entries', path: '/sales-entries', roles: ['ADMIN', 'PRODUCTION_MANAGER'], group: 'Sales', icon: Receipt },
  { label: 'Advance Case Booking', path: '/case-bookings', roles: ['ADMIN', 'PRODUCTION_MANAGER'], group: 'Sales', icon: CalendarClock },
  { label: 'Distributors', path: '/distributors', roles: ['ADMIN', 'PRODUCTION_MANAGER'], group: 'Sales', icon: Truck },

  { label: 'Work Orders', path: '/plans', roles: ['ADMIN', 'PRODUCTION_MANAGER', 'LINE_SUPERVISOR'], group: 'Production', icon: ClipboardList },
  { label: 'Production Entries', path: '/production-entries', roles: ['ADMIN', 'PRODUCTION_MANAGER', 'LINE_SUPERVISOR'], group: 'Production', icon: HardHat },
  ...
  { label: 'Wastage Entries', path: '/waste-entries', roles: ['ADMIN', 'PRODUCTION_MANAGER', 'LINE_SUPERVISOR'], group: 'Quality', icon: PackageX },
  { label: 'Wastage Report', path: '/waste-report', roles: ['ADMIN', 'PRODUCTION_MANAGER', 'LINE_SUPERVISOR'], group: 'Quality', icon: Recycle },

  { label: 'Petty Cash', path: '/petty-cash', roles: ['ADMIN', 'PRODUCTION_MANAGER'], group: 'Accounts', icon: Wallet },
...
export const SEARCH_KPIS: SearchKpi[] = [
  ...
  },
  {
    ...
    path: '/case-bookings',
    keywords: ['advance', 'advanced', 'case booking', 'pre order', 'booking', 'delivery date', 'distributor booking'],
  },
  {
    label: 'Distributors',
